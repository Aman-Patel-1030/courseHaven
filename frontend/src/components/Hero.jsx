...
const data = [
  {
    id: 1,
    src: " https://res.cloudinary.com/ds9foulqt/image/upload/v1753206797/AI-Graphic-design-tools-1000x600_kor9tx.webp",
  ...
  {
    id: 2,
    src: "https://res.cloudinary.com/ds9foulqt/image/upload/v1753207276/SEO-Masterclass-Course_rseesw.webp",
  ...
  return (
    <div className="frame relative overflow-x-hidden">
      ...
      <div className="btns absolute w-screen justify-center bottom-10 m-auto  z-[1] text-white text-2xl flex gap-10 ">
        <button
          onClick={prevSlide}
          className="prev-btn w-14 h-10 lg:h-14 lg:w-20 flex justify-center items-center bg-primary-900 text-white border border-white hover:bg-primary-900/75 hover:text-gray-200 hover:border-gray-200 duration-300"
        >
          <span>
            <BsArrowLeft />
          </span>
        ...
        <button
          onClick={nextSlide}
          className="next-btn  w-14 h-10 lg:h-14 lg:w-20 flex justify-center items-center bg-primary-900 text-white border border-white hover:bg-primary-900/75 hover:text-gray-200 hover:border-gray-200 duration-300"
        >
          <span>
            <BsArrowRight />
          </span>
