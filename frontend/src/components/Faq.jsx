...
const martialsArtFaq = [
  ...
  {
    id: 4,
    question: "Are there any live or interactive components to Cordemy courses?",
    answer:
...
const Faq = () => {
  ...
  return (
    <section className="section-padding mb-20 mt-28 px-4 md:px-12">
      <SectionHeader
        span="Faq"
      ...
      <div className="wrapper grid grid-cols-1 lg:grid-cols-2 gap-20 items-center justify-center mt-14">
        {/* Left image */}
        <div
        ...
        <div data-aos="fade-left" data-aos-duration="1000">
          {martialsArtFaq.map((faq, index) => (
            <div key={faq.id} className="w-full">
              <div
                className={`faq-item flex justify-between mt-6 items-center p-3 bg-primary-900 shadow-sm shadow-white/30 rounded-md cursor-pointer ${
              ...
              {open === index && (
                <div className="shadow-sm shadow-white rounded-md p-3 mt-2 bg-primary-900 ">
